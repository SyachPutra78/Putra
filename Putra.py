...
def waktu():
	now = datetime.now()
	hours = now.hour
	if 4 <= hours < 12:timenow = "Selamat Pagi mas bro"
	elif 12 <= hours < 15:timenow = "Selamat Siang mas bro"
	elif 15 <= hours < 18:timenow = "Selamat Sore mas bro"
	else:timenow = "Selamat Malam mas bro lapar gak"
	return timenow
...
def Nomor():
	print()
	depan = input('* awalan nomor (contoh > 0899/0852/0812/0822/0813/0821) : ')
	if len(depan)==3:pass
	else:exit(f'* contoh awalan nomor 0899/0852/0812/0822/0813/0821')
	jumla = input('* jumlah : ')
...
def crack(idf,pwv):
	global loop,ok,cp
	emot = random.choice(["🇮🇩Syp🇮🇩","😂Ptr🤣","🇮🇩Syp🇮🇩","😂Ptr🤣","🇮🇩Syp🇮🇩","😂Ptr🤣","🇮🇩Syp🇮🇩","😂Ptr🤣","🇮🇩Syp🇮🇩","😂Ptr🤣","🇮🇩Syp🇮🇩","😂Ptr🤣"])
